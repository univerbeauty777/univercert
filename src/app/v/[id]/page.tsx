        ...
        <article className="card-glass relative overflow-hidden p-8 md:p-10 animate-scale-in shadow-card-lift">
          ...
          {!isRevoked && (
            <div className="mt-7 flex gap-2.5 flex-wrap">
              ...
              <a href={`/api/v1/credentials/${credential.id}/openbadge.json`} target="_blank" rel="noopener" className="btn-ghost text-sm">Open Badge</a>
              <a href={`https://wa.me/?text=${waText}`} target="_blank" rel="noopener" className="btn-ghost text-sm" style={{ background: 'rgba(37,211,102,0.1)', color: '#1EA952' }}>💬 WhatsApp</a>
            </div>
          )}
